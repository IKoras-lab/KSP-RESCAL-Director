...
- I have included support toggles for scale incase you are using scale changing mod.
...
- I modified a code for an graphic plotter to work for the calculator.
- Have started to implement Radio recommendations biased on the calculated orbit (big WIP)
